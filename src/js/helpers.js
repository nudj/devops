...
const OLD_COLLECTIONS = {
  ...
  COMPANY_INTEGRATIONS: TABLES.COMPANY_INTEGRATIONS,
  JOBS: TABLES.JOBS,
...
const RELATIONS = {
  ...
  [TABLES.COMPANY_INTEGRATIONS]: {
    [FIELDS[TABLES.COMPANY_INTEGRATIONS].COMPANY]: TABLES.COMPANIES
  },
  [TABLES.SURVEY_QUESTIONS]: {
    [FIELDS[TABLES.SURVEY_QUESTIONS].SURVEY]: TABLES.SURVEYS
  },
  [TABLES.SURVEY_ANSWERS]: {
...
const ORDER_CACHES = {
  [TABLES.SURVEYS]: {
    [FIELDS[TABLES.SURVEYS].SURVEY_QUESTIONS]: TABLES.SURVEY_QUESTIONS
  }
}
